...
public class OrdersControllerTests
{
    private OrdersController CreateController(Mock<IOrderService> service, ClaimsPrincipal? user = null)
    {
        ...
        // Guard: Ensure NameIdentifier claim is present for all tests
        if (principal.FindFirst(ClaimTypes.NameIdentifier) == null)
            throw new ArgumentException("ClaimsPrincipal must have a NameIdentifier claim for controller actions.");
